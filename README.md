...
[![Download FastPAS Portable for Windows x64](https://img.shields.io/badge/Download-FastPAS%20Portable%20for%20Windows%20x64-0078D4?style=for-the-badge&logo=windows)](https://github.com/HSFerrum/FastPAS/releases/download/v0.1.2/FastPAS-portable-windows-x64.zip)
...
**[Download the complete FastPAS Portable Windows package (277 MB)](https://github.com/HSFerrum/FastPAS/releases/download/v0.1.2/FastPAS-portable-windows-x64.zip)**
...
Portable configuration is stored in `FastPASData` beside the executable.
Existing FastPAS profiles, tenants, and passcodes from the Windows user profile
are not imported into a newly extracted portable folder.
